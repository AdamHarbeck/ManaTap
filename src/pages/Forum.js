...
const Forum = () => {
    ...
    function addPost(){
        ...
        gCopy.push(futurePost)
        console.log(gCopy);
        setGeneral(gCopy)
        console.log(general, sets);
    }
    ...
    return(
        <div style={styles.container} id={`forumDiv`}>
            ...
            {console.log(general, sets)}
            {gCopy.map(element =>(
                <TopicCard key={element.title} id={element.title} val={element} />
            ))}
            ...
            {/*<h1>Cards</h1>*/}
            {/*{forum.cards.map((element)=>{*/}
            {/*    return <TopicCard key={element.title} val={element} />*/}
            {/*})}*/}

            {/*<h1>Decks</h1>*/}
            {/*{forum.decks.map((element)=>{*/}
            {/*    return <TopicCard key={element.title} val={element} />*/}
            {/*})}*/}

            {/*<h1>Tournaments</h1>*/}
            {/*{forum.tournaments.map((element)=>{*/}
            {/*    return <TopicCard key={element.title} val={element} />*/}
            {/*})}*/}
